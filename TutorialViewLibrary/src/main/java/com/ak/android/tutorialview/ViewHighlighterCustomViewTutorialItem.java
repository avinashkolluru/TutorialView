...
public class ViewHighlighterCustomViewTutorialItem implements TutorialItem{
    ...
    public View getView(){
        RelativeLayout parent = (RelativeLayout)LayoutInflater.from(activity).inflate(R.layout.tutorial_view_custom_layout_parent, null);
        RelativeLayout v = (RelativeLayout)LayoutInflater.from(activity).inflate(this.layoutId, parent, true);
        ...
        if(-1 != viewId) {
            ...
            if(null != anchorView) {
                ...
                BackgroundViewAnchorHighlighter backgroundViewHighlighter = (BackgroundViewAnchorHighlighter) parent.findViewById(R.id.tutorial_frame_background_view_highlighter);
